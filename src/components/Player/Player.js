  ...
  render() {
    ...
    return (
      <div className={`theme-player--${this.props.isDark ? 'dark' : 'light'}`}>
        <div ref={this.props.playerRef} className='player'>
          <CSSTransition
            in={true}
            timeout={1000}
            appear
